...
while True:
    ...
    for i in range(10, 0, -1):
        ...
        timer1_section.write("(Từ vựng tiếp theo sau {} s)".format(i))
        timer2_section.write("(Từ vựng tiếp theo sau {} s)".format(i))
        timer3_section.write("(Từ vựng tiếp theo sau {} s)".format(i))
        timer4_section.write("(Từ vựng tiếp theo sau {} s)".format(i))
        timer5_section.write("(Từ vựng tiếp theo sau {} s)".format(i))
